...
class DetailsMyOrder2 extends StatefulWidget {
  DetailsMyOrder2({Key key}) : super(key: key);

  @override
  _DetailsMyOrder2State createState() => _DetailsMyOrder2State();
}

class _DetailsMyOrder2State extends State<DetailsMyOrder2> {
  @override
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text("Discount", style: theme.textTheme.subtitle2.copyWith(color: Colors.black)),
                    Text("- \$10", style: theme.textTheme.subtitle2.copyWith(color: Colors.black)),
                  ],
                ),
              ),
